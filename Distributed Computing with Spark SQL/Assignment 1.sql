...
SELECT COUNT(*) AS count FROM fireIncidents
...
SELECT `Ignition Cause`, COUNT(*) AS FireCalls FROM fireIncidents
...
SELECT COUNT(*) as count FROM firecalls
INNER JOIN fireincidents
ON firecalls.Battalion = fireincidents.Battalion
